...
!!! TIP "Shimano stamped text should be on the outside of the chain"
...
If the chain being replaced was damaged it may not be the right length.  Wrap the new chain around the largest front ring and largest casette ring, there should be two extra links (4 pins) for the correct chain length.
