...
[Chiddingstone Cafe](https://ridewithgps.com/routes/52396047){target=_blank .md-button}


### Kent Alps

[Four Ascents Baileys & Pol Hill South](https://ridewithgps.com/routes/43855001){target=_blank .md-button}

[Six Ascents Baileys & Toys Hill South](https://ridewithgps.com/routes/39349514){target=_blank .md-button}

[Eight Ascents Pol Hill](https://ridewithgps.com/routes/53656428){target=_blank .md-button}

[Eight Ascents Star Hill](https://ridewithgps.com/routes/53656413){target=_blank .md-button}
...
[Lenham Loop](https://ridewithgps.com/routes/47746331){target=_blank .md-button}

[Marden Cafe](https://ridewithgps.com/routes/51829622){target=_blank .md-button}


### Seaside

[Dymchurch](https://ridewithgps.com/routes/7993547){target=_blank .md-button} - 200km, 1250m

[Dunwich Dynamo](https://ridewithgps.com/routes/29642630){target=_blank .md-button} - 170km each way
...
A relatively quite route with traffic only on Poll Hill and the A21.  A good series of modest climbs and speedy descents.

Starting along the A21 and up though Knockholt to the top of Pol Hill.  A speedy decent down Pol Hill, turning left down to Otford.

Then a quick clime up to Kemsing before dropping down to Seal.

A steady climb up through Gothurst Common and short climb into Ide Hill Village.  Followed by a long, fast decent to Sundridge.

A fairly flat ride before the climb up Poll Hill, with a fast decent back through Knockholt and along the A21.
...
!!! WARNING "Untested route"

A ride to test climbing skills on Virgo Hill, which peaks at 23.4% although is an average of only 7% 🤣

The rest of the climbing is typical of a club run route, with some challenges but nothing as significant as Virgo Hill.
...
- Kentish Killer with revised start & end points
- Hell Of The Ashdown with revised start & end points
-->
